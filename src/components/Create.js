    ...
    return (
      <main className={`col-md-10 create ${this.state.loading ? 'loading' : ''}`}>
        ...
        <div className="row form-group">
          <label className="col-md-2 col-form-label" htmlFor="input">Input</label>
          <input id="input" ref={input => { this.input = input }}
            defaultValue="file:/Users/jelovirt/Work/dita-ot/src/main/docsrc/userguide.ditamap"
            type="url" required className="col-md-10 form-control" placeholder="Input file URI" />
        </div>
        <div className="row form-group">
          <label className="col-md-2 col-form-label" htmlFor="transtype">Transtype</label>
          <select id="transtype" ref={transtype => { this.transtype = transtype }} required className="col-md-10 form-control">
        ...
        <div className="row form-group">
          <label className="col-md-2 col-form-label" htmlFor="output">Output</label>
          <input id="output" ref={output => { this.output = output }} defaultValue="file:/Volumes/tmp/platform/out/"
            placeholder="Output file URI" type="url" className="col-md-10 form-control" />
        </div>
        <p>
